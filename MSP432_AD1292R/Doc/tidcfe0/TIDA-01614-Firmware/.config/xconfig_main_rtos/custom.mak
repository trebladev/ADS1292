...
linker.cmd: package/cfg/main_rtos_pem4f.xdl
	$(SED) 's"^\"\(package/cfg/main_rtos_pem4fcfg.cmd\)\"$""\"D:/Firmware/TIDA firmware/Swaroop/TIDA - 2/TIDA-01614-Firmware/.config/xconfig_main_rtos/\1\""' package/cfg/main_rtos_pem4f.xdl > $@
