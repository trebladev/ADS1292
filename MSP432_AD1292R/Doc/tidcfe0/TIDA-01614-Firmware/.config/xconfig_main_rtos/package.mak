...
override PKGDIR = xconfig_main_rtos
...
package/%.xdc.inc package/%_xconfig_main_rtos.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package xconfig_main_rtos" (because $@ is older than $(firstword $?))" ...
...
.PHONY: release,xconfig_main_rtos
ifeq (,$(MK_NOGENDEPS))
-include package/rel/xconfig_main_rtos.tar.dep
endif
package/rel/xconfig_main_rtos/xconfig_main_rtos/package/package.rel.xml: package/package.bld.xml
package/rel/xconfig_main_rtos/xconfig_main_rtos/package/package.rel.xml: package/build.cfg
package/rel/xconfig_main_rtos/xconfig_main_rtos/package/package.rel.xml: package/package.xdc.inc
package/rel/xconfig_main_rtos/xconfig_main_rtos/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

xconfig_main_rtos.tar: package/rel/xconfig_main_rtos.xdc.inc package/rel/xconfig_main_rtos/xconfig_main_rtos/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/xconfig_main_rtos.xdc.inc,package/rel/xconfig_main_rtos.tar.dep)


release release,xconfig_main_rtos: all xconfig_main_rtos.tar
clean:: .clean
	-$(RM) xconfig_main_rtos.tar
	-$(RM) package/rel/xconfig_main_rtos.xdc.inc
	-$(RM) package/rel/xconfig_main_rtos.tar.dep
